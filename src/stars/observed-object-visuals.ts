...
export const OBSERVED_VISUAL_PROFILES: Record<string, ObservedVisualProfile> = {
  ...
  vycma: p({ morphology: "dusty-supergiant", seed: 58061, tilt: [0.2, 0.4, 0], spin: 0.02 }),
  rigel: p({ morphology: "white-dwarf", seed: 34085, tilt: [0, 0, 0], spin: 0.05 }),
  antares: p({ morphology: "red-supergiant", seed: 148478, tilt: [0.1, 0.2, 0], spin: 0.02 }),
  r136a1: p({ morphology: "white-dwarf", seed: 136001, tilt: [0, 0, 0], spin: 0.08 }),
  polaris: p({ morphology: "red-supergiant", seed: 8890, tilt: [0.05, 0.1, 0], spin: 0.04 }),
  mira: p({ morphology: "dusty-supergiant", seed: 14386, tilt: [0.3, -0.2, 0.1], spin: 0.015 }),
  ttauri: p({ morphology: "dusty-supergiant", seed: 284419, tilt: [-0.2, 0.35, 0.1], spin: 0.03 }),
  tabby: p({ morphology: "white-dwarf", seed: 8462852, tilt: [0, 0, 0], spin: 0.04 }),
  algol: p({ morphology: "white-dwarf", seed: 19356, tilt: [0, 0, 0], spin: 0.06 }),
  proxima: p({ morphology: "red-supergiant", seed: 70890, tilt: [0, 0, 0], spin: 0.05 }),
  luhman16: p({ morphology: "red-supergiant", seed: 104953, tilt: [0.1, 0, 0], spin: 0.03 }),
  vanmaanen: p({ morphology: "white-dwarf", seed: 4605, tilt: [0, 0, 0], spin: 0.03 }),
  methuselah: p({ morphology: "white-dwarf", seed: 140283, tilt: [0, 0, 0], spin: 0.02 }),
  regulus: p({ morphology: "white-dwarf", seed: 87901, tilt: [0, 0, 0], spin: 0.09 }),
};
